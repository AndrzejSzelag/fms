...
4. Download the __Oracle Database 21c Express Edition__ (_OracleXE213_Win64.zip), extract zip file to a local directory and run __setup.exe__. After installation:
