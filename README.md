...
5. Download __Payara Server 5.2021.10__ and extract zip file to a local directory.
    ...
    > #### IMPORTANT
    > Copy __ojdbc11.jar__ file from __Oracle Database 21c Express Edition__ (__lib\__ folder) to __Payara Server__ (__lib\__ folder)!
...
11. From __fms\target__ folder deploy __FMS-1.0.war__ file to the __Payara Server 5.2021.10__ (you can use __asadmin deploy__ command).
    ...
    > #### IMPORTANT
    > In __Oracle Database 21c Express Edition__ run __data.sql__ file from __\fms\src\main\resources\__ folder!
